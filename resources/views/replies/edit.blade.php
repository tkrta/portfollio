                    ...
                    <div class= "reply_content">
                        <form action= "/posts/replies/{{ $post->id }}/{{ $reply->id }}" method= "POST">
                            ...
                            <div class= "content_title">
                                ...
                                <input type= 'text' name= 'reply[title]' value= "{{ $reply->title }}" class="block w-56 mx-auto text-center text-xl"/>
                            </div>
                            <div class= "content_body">
                                <h2 class="my-6 ml-8 text-2xl">本文</h2>
                                <input type= 'text' name= 'reply[body]' value= "{{ $reply->body }}" class="block w-56 mx-auto text-center text-xl h-12"/>
                            </div>
